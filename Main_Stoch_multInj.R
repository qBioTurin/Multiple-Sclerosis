...
#events<-InjectionSetting.generation(InjATime=24*2 , numberA = 100)
events<-InjectionSetting.generation(InjATime=c(2,67,127,295,300,303,307,600)*24 , numberA = 100)
...
if(file.exists("Mult_Healthy_Stoch_analysis")) system(paste('rm -dr', sprintf("Mult_Healthy_Stoch_analysis")) )
system(paste('mv', 
...
if(file.exists("Mult_MS_Stoch_analysis")) system(paste('rm -dr', sprintf("Mult_MS_Stoch_analysis")) )
system(paste('mv',
             sprintf("results_model_analysis"),
             sprintf("Mult_MS_Stoch_analysis")) )
